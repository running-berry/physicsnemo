...
def main():
    ...
    parser.add_argument(
        "--variable", choices=["t2m", "u10"], required=True, help="Variable to plot"
    )
    args = parser.parse_args()

    era5_data, era5_lat, era5_lon, era5_times = load_data(
        args.era5_path, "era5", args.variable
    )
    rwrf_data, rwrf_lat, rwrf_lon, rwrf_times = load_data(
