...
PYTHONPATH="$UTIL_DIR:$PYTHONPATH" python npz_2_zarr_ori.py \
    ...
    --zarr-base /workspace/NCDR_StormCast/des/zarr_exp_1_L_26_H_74 \
    --experiment-name stormcast_test \
    --train-ranges "2019/08/01:2020/08/31" \
    --valid-ranges "2020/09/01:2021/08/31" \
    --split both \
    --log-level DEBUG --log-file /workspace/physicsnemo/dev/rwrf_process/des_npz_2_zarr/nzarr_exp_1_L_26_H_74.log \