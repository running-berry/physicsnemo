...
srun -N 1 -w cnode3-002 -p NCDR_StormCast --mpi=pmix --gres=gpu:8 --ntasks-per-node 1 \
  --container-image /mnt/home/dczy-cmla-8ec31f/physicsnemo_25.03_02.sqsh \
  --container-writable \
  --container-remap-root \
  --container-mounts=/mnt/home/dczy-cmla-8ec31f/projects/N2/physicsnemo:/workspace,\
